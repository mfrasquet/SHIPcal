...
def get_energy_gain(weather: Weather, step: int) -> float:
    """
    This function considers the energy gain with the optical losses of
    the collector.
...
if __name__ == "__main__":
    ...
    step = 12
    energy_loss = get_energy_gain(weather, step)
